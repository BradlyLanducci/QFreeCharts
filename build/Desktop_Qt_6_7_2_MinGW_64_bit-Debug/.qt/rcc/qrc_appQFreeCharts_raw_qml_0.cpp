...
0x0,0x0,0x1,0x91,0xe9,0xde,0x35,0x2f,
...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appQFreeCharts_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appQFreeCharts_raw_qml_0)()
{
    int version = 3;
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appQFreeCharts_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appQFreeCharts_raw_qml_0)()
{
    int version = 3;
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_appQFreeCharts_raw_qml_0)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appQFreeCharts_raw_qml_0)(); }
   } dummy;
}
